...
insert into PARTICIPATION (PARTICIPATION_ID, DRIVER_GROUP_DRIVER_GROUP_ID, QUALIFYING_SESSION_ID, RACE_SESSION_ID, REGISTRATION_DATE) VALUES (2, 6, 1, 2, '3.5.2017');
insert into PARTICIPATION (PARTICIPATION_ID, DRIVER_GROUP_DRIVER_GROUP_ID, QUALIFYING_SESSION_ID, RACE_SESSION_ID, REGISTRATION_DATE) VALUES (3, 9, 1, 2, '6.5.2017');
insert into PARTICIPATION (PARTICIPATION_ID, DRIVER_GROUP_DRIVER_GROUP_ID, QUALIFYING_SESSION_ID, RACE_SESSION_ID, REGISTRATION_DATE) VALUES (4, 12, 1, 2, '2.5.2017');
insert into PARTICIPATION (PARTICIPATION_ID, DRIVER_GROUP_DRIVER_GROUP_ID, QUALIFYING_SESSION_ID, RACE_SESSION_ID, REGISTRATION_DATE) VALUES (5, 2, 3, 4, '1.1.2017');
insert into PARTICIPATION (PARTICIPATION_ID, DRIVER_GROUP_DRIVER_GROUP_ID, QUALIFYING_SESSION_ID, RACE_SESSION_ID, REGISTRATION_DATE) VALUES (6, 5, 3, 4, '5.1.2017');
insert into PARTICIPATION (PARTICIPATION_ID, DRIVER_GROUP_DRIVER_GROUP_ID, QUALIFYING_SESSION_ID, RACE_SESSION_ID, REGISTRATION_DATE) VALUES (7, 8, 3, 4, '4.1.2017');
insert into PARTICIPATION (PARTICIPATION_ID, DRIVER_GROUP_DRIVER_GROUP_ID, QUALIFYING_SESSION_ID, RACE_SESSION_ID, REGISTRATION_DATE) VALUES (8, 11, 3, 4, '2.1.2017');
commit;
...
insert into RESULTS (BEST_QUALIFYING_LAPTIME, STARTING_POSITION, PITS_COUNT, FINAL_POSITION, POINTS, INCIDENT_COUNT, PARTICIPATION_PARTICIPATION_ID) VALUES ('2:20.152', 3, 14, 2, 400, 5, 4);
insert into RESULTS (BEST_QUALIFYING_LAPTIME, STARTING_POSITION, PITS_COUNT, FINAL_POSITION, POINTS, INCIDENT_COUNT, PARTICIPATION_PARTICIPATION_ID) VALUES ('2:21.002', 1, 13, 3, 300, 7, 2);
insert into RESULTS (BEST_QUALIFYING_LAPTIME, STARTING_POSITION, PITS_COUNT, FINAL_POSITION, POINTS, INCIDENT_COUNT, PARTICIPATION_PARTICIPATION_ID) VALUES ('2:21.104', 4, 12, 4, 200, 15, 3);
insert into RESULTS (BEST_QUALIFYING_LAPTIME, STARTING_POSITION, PITS_COUNT, FINAL_POSITION, POINTS, INCIDENT_COUNT, PARTICIPATION_PARTICIPATION_ID) VALUES ('1:34.062', 3, 2, 1, 500, 2, 6);
insert into RESULTS (BEST_QUALIFYING_LAPTIME, STARTING_POSITION, PITS_COUNT, FINAL_POSITION, POINTS, INCIDENT_COUNT, PARTICIPATION_PARTICIPATION_ID) VALUES ('1:33.999', 2, 2, 2, 400, 1, 8);
insert into RESULTS (BEST_QUALIFYING_LAPTIME, STARTING_POSITION, PITS_COUNT, FINAL_POSITION, POINTS, INCIDENT_COUNT, PARTICIPATION_PARTICIPATION_ID) VALUES ('1:33.961', 1, 2, 3, 300, 1, 5);
insert into RESULTS (BEST_QUALIFYING_LAPTIME, STARTING_POSITION, PITS_COUNT, FINAL_POSITION, POINTS, INCIDENT_COUNT, PARTICIPATION_PARTICIPATION_ID) VALUES ('1:34.102', 4, 2, 4, 200, 3, 7);
commit;
